package com.capacitorjs.plugins.hmslocalnotifications;
...
public class LocalNotificationManager {
    ...
    // Action constants
    public static final String NOTIFICATION_INTENT_KEY = "HmsLocalNotificationId";
    public static final String NOTIFICATION_OBJ_INTENT_KEY = "HmsLocalNotficationObject";
    public static final String ACTION_INTENT_KEY = "HmsLocalNotificationUserAction";
    public static final String NOTIFICATION_IS_REMOVABLE_KEY = "HmsLocalNotificationRepeating";
    public static final String REMOTE_INPUT_KEY = "HmsLocalNotificationRemoteInput";
    ...
    private void buildNotification(NotificationManagerCompat notificationManager, LocalNotification localNotification, PluginCall call) {
        ...
        if (localNotification.isScheduled()) {
            ...
            /* try {
                ...
                PushNotificationsPlugin.fireReceivedStatic(notificationJson);
            } catch (JSONException e) {}*/
